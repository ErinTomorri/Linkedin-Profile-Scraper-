...
class LinkedInPeopleProfileSpider(scrapy.Spider):
    ...
    def login(self, response):
        ...
        Cookies = response.css('form input[name="loginCsrfParam"]::attr(value)').extract_first()
        page_instance = response.css('form input[name="pageInstance"]::attr(value)').extract_first()
        ...
        yield FormRequest.from_response(response,
            ...
            formdata={'csrfToken': token,'session_key': '@gmail.com', 'session_password': ''},
